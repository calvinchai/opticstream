...
# grid, tiles = process_tile_coord("/autofs/space/zircon_007/users/psoct-pipeline/sub-I80/TileConfigurationAll.txt",
#                  "/autofs/space/zircon_007/users/psoct-pipeline/sub-I80/TileConfigurationAll.registered.txt",
...
fiji_stitch.main(directory = "/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/processed/",
file_template = "mosaic_013_image_{iiii}_aip.nii",
grid_size_x = 21,
grid_size_y = 27)
process_tile_coord(ideal_coord_file="/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/processed/TileConfiguration.txt",
...
fit_coord_files.main(input="/space/zircon/5/users/data/sub-I80_voi-slab2/mosaic_013_tile_coords_export.yaml",
                    ...
                    scan_resolution=[0.01, 0.01])
mosaic2d(tile_info_file="/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/mosaic_013_aip.yaml",
...
generate_mask.main(input="/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/mosaic_013_aip.nii",
...
for modality in ["ret", "ori", "biref", "mip", "surf"]:
    ...
    mosaic2d(tile_info_file=f"/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/mosaic_013_{modality}.yaml",
...
process_tile_coord(ideal_coord_file="/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/processed/TileConfigurationTilted.txt",
...
fit_coord_files.main(input="/space/zircon/5/users/data/sub-I80_voi-slab2/mosaic_014_tile_coords_export.yaml",
                    output="/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/mosaic_014_aip.yaml",
                    base_dir="/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/processed/",
                    scan_resolution=[0.01, 0.01])
mosaic2d(tile_info_file="/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/mosaic_014_aip.yaml",
...
generate_mask.main(input="/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/mosaic_014_aip.nii",
...
for modality in ["ret", "ori", "biref", "mip", "surf"]:
    ...
    mosaic2d(tile_info_file=f"/space/zircon/5/users/data/sub-I80_voi-slab2/slice-07/mosaic_014_{modality}.yaml",

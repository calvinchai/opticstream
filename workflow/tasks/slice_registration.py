...
- thruplane_from_files: Registers normal and tilted illuminations from NIfTI files
  and generates 3D axis visualizations in a single call

This replaces the old two-step process (thruplane + RGB_3Daxis) with a unified
function that takes explicit file paths.
"""

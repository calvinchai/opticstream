...
The `opticstream deploy` CLI command helps you create Prefect deployments for
the main OpticStream workflows.
...
Use `opticstream deploy --help` for a full list of supported flows and options.

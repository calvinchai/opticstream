...
def process_folder(
    folder_path, project_name, project_base_path, mosaic_ranges, batch_id_counter
    ):
    """
        ...
        for mosaic_id in range(min_mosaic_id, max_mosaic_id + 1):
            ...
            for fpath in file_list:
                ...
                try:
                    ...
                    print(
                        f"Warning: Could not parse tile_index from {basename}, "
                        f"skipping")
                    continue
            ...
            for batch_id_for_tile, batch_files in sorted(batches.items()):
                ...
                if len(batch_files) < batch_size:
                    print(
                        f"Warning: Incomplete batch for mosaic {mosaic_id}, logical_batch_id {batch_id_for_tile} "
                ...
                try:
                    print(
                        f"Triggering deployment for mosaic {mosaic_id} with {len(batch_files)} files "
...
if __name__ == "__main__":
    ...
    # Process /mnt/sas2/I80_frontal_20251210/
    # Mosaics 1-10 with batch_size=28
    # Mosaics 11-12 with batch_size=27
    folder_path_1 = "/mnt/sas2/I80_frontal_20251210/"
    mosaic_ranges_1 = [
        # (1, 10, 28),   # mosaics 1-10, batch_size=28
        (11, 12, 27),  # mosaics 11-12, batch_size=27
    ]
    ...
    # Process /mnt/sas2/I80_frontal_slice7_20251212/
    # Mosaics 13-14 with batch_size=27
    folder_path_2 = "/mnt/sas2/I80_frontal_slice7_20251212/"
    mosaic_ranges_2 = [
        (13, 14, 27),  # mosaics 13-14, batch_size=27
    ]

    print(f"\nProcessing folder: {folder_path_2}")
    batch_id_counter = process_folder(
        folder_path_2,
        project_name,
        project_base_path,
    ...
    print(f"\nTotal batches processed: {batch_id_counter}")
